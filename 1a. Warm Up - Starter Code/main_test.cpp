...
int main()
{
    ...
    float timeMultiplier = 100 * SECONDS_PER_DAY; // Simulation speed: 100 days
                                                  //  per real second
    ...
    if (sim->orbitalBodies[0].position.x != -1.283674643550172E+09F)
    {
    ...
    // Modify to suit your code:
    if (sim->orbitalBodies[0].position.x != -1.284506496E+09F)
    {
